...
# judul
judul = tk.Label(root, text="Absensi", font=("Roboto",34),bg="#242526", fg="white")
canvas.create_window(350, 80, window=judul)
#credit
made = tk.Label(root, text="Made by PT. XXX", font=("Times New Roman",13), bg="black",fg="white")
...
label1 = tk.Label(root, text="Nama Karyawan", font="Roboto", fg="white", bg="black")
...
label2 = tk.Label(root, text="ID Karyawan", font="Roboto", fg="white", bg="black")
...
label3 = tk.Label(root, text="Divisi", font="Roboto", fg="white", bg="black")
